        ...
        <div className='nav-container'>
            <nav style={windowHeight >= 500 ? { backgroundColor: props.open ? "white" : "black", position: "fixed", top: "0", zIndex: "5" } : { backgroundColor: props.open ? "transparent" : "black" }}>
                <div className="nav-logo">
                    ...
                    <svg width="40" height="40" className='mobile-svg' viewBox="0 0 50 50"><g transform="translate(-3894 2762)"><rect width="50" height="50" rx="8" transform="translate(3894 -2762)" fill="#07a081"></rect><path d="M32.671,44.73h7.091V37.935H41.9a5.657,5.657,0,1,0,0-11.314H32.671Zm10.763,3.622H29V23H41.9a9.271,9.271,0,0,1,1.53,18.435Z" transform="translate(3880 -2773)" fill="#fff"></path></g></svg>

                </div>

                <div className="nav-input-container" style={windowHeight >= 500 ? { visibility: 'visible' } : { visibility: props.open ? "hidden" : "visible" }}>
                ...
                <div className="nav-left">
                    <ul className="nav-items">
                        <li className={windowHeight >= 500 ? "nav-link-extra" : "nav-link"} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
                            <p>explore</p>
                            {hover
                                ? <svg fill={windowHeight >= 500 ? "#000000" : "#ffffff"} width="12px" height="12px" viewBox="0 0 32.00 32.00"  stroke={windowHeight >= 500 ? "#000000" : "#ffffff"} ><g id="SVGRepo_bgCarrier" ></g><g id="SVGRepo_tracerCarrier" ></g><g id="SVGRepo_iconCarrier"><path d="M 16 6.59375 L 15.28125 7.28125 L 2.78125 19.78125 L 4.21875 21.21875 L 16 9.4375 L 27.78125 21.21875 L 29.21875 19.78125 L 16.71875 7.28125 Z"></path></g></svg>
                                : <svg fill={windowHeight >= 500 ? "#000000" : "#ffffff"} height="12px" width="12px" version="1.1" id="Layer_1"  viewBox="0 0 330 330"  stroke={windowHeight >= 500 ? "#000000" : "#ffffff"} ><g id="SVGRepo_bgCarrier" ></g><g id="SVGRepo_tracerCarrier" ></g><g id="SVGRepo_iconCarrier"> <path id="XMLID_225_" d="M325.607,79.393c-5.857-5.857-15.355-5.858-21.213,0.001l-139.39,139.393L25.607,79.393 c-5.857-5.857-15.355-5.858-21.213,0.001c-5.858,5.858-5.858,15.355,0,21.213l150.004,150c2.813,2.813,6.628,4.393,10.606,4.393 s7.794-1.581,10.606-4.394l149.996-150C331.465,94.749,331.465,85.251,325.607,79.393z"></path></g></svg>
                            }
                    ...
                    <button className="nav-btn-svg" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} >
                        <svg fill={windowHeight >= 500 ? "black" : "#ffffff"} height="16px" width="16px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32.055 32.055" xml:space="preserve" stroke="#fffff"><g id="SVGRepo_bgCarrier" ></g><g id="SVGRepo_tracerCarrier" ></g><g id="SVGRepo_iconCarrier"> <g> <path d="M3.968,12.061C1.775,12.061,0,13.835,0,16.027c0,2.192,1.773,3.967,3.968,3.967c2.189,0,3.966-1.772,3.966-3.967 C7.934,13.835,6.157,12.061,3.968,12.061z M16.233,12.061c-2.188,0-3.968,1.773-3.968,3.965c0,2.192,1.778,3.967,3.968,3.967 s3.97-1.772,3.97-3.967C20.201,13.835,18.423,12.061,16.233,12.061z M28.09,12.061c-2.192,0-3.969,1.774-3.969,3.967 c0,2.19,1.774,3.965,3.969,3.965c2.188,0,3.965-1.772,3.965-3.965S30.278,12.061,28.09,12.061z"></path> </g> </g></svg>
                    </button>
                    <button className="nav-btn" style={windowHeight >= 500 ? { backgroundColor: '#05A081', color: 'white' } : { backgroundColor: 'white' }}>join</button>
                </div>
                <div className="hamburger">
                    <button className={props.open ? "nav-btn" : "none"} style={windowHeight >= 500 ? { backgroundColor: '#05A081', color: 'white', display: "none" } : { backgroundColor: 'white' }} >
                        join
                    </button>
                    {props.open ?
                        <svg width="24px" onClick={props.toggle} height="24px" viewBox="0 0 24 24" fill="none"  stroke={windowHeight >= 500 ? props.open ? "white" : "#ffffff" : "#ffffff"}><g id="SVGRepo_bgCarrier" ></g><g id="SVGRepo_tracerCarrier" ></g><g id="SVGRepo_iconCarrier"> <path d="M4 18L20 18" stroke={windowHeight >= 500 ? "#000000" : "#ffffff"} ></path> <path d="M4 12L20 12" stroke={windowHeight >= 500 ? "#000000" : "#ffffff"} ></path> <path d="M4 6L20 6" stroke={windowHeight >= 500 ? "#000000" : "#ffffff"} ></path> </g></svg>
                        :
                        <svg width="36px" onClick={props.toggle} height="36px" viewBox="0 0 24 24" fill="none"  stroke={windowHeight >= 500 ? props.open ? "white" : "#ffffff" : "#ffffff"}><g id="SVGRepo_bgCarrier" ></g><g id="SVGRepo_tracerCarrier" ></g><g id="SVGRepo_iconCarrier"> <path d="M16 8L8 16M8.00001 8L16 16" stroke={windowHeight >= 500 ? props.open ? "white" : "#ffffff" : "#ffffff"} ></path> </g></svg>
                    }
                </div>
            </nav>
