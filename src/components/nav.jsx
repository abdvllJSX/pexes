        ...
        <>
            <nav style={windowHeight >= 500 ? { backgroundColor: props.open ? "white" : "black", position: "fixed", top: "0", zIndex: "5" } : { backgroundColor: props.open ? "transparent" :  "black"}}>
                ...
                <div className="hamburger">
                    ...
                    {open ?
                        <svg width="24px" onClick={props.toggle} height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={windowHeight >= 500 ? props.open ? "white" : "#ffffff" : "#ffffff"}><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 18L20 18" stroke={windowHeight >= 500 ? "#000000" : "#ffffff"} stroke-width="2" stroke-linecap="round"></path> <path d="M4 12L20 12" stroke={windowHeight >= 500 ? "#000000" : "#ffffff"} stroke-width="2" stroke-linecap="round"></path> <path d="M4 6L20 6" stroke={windowHeight >= 500 ? "#000000" : "#ffffff"} stroke-width="2" stroke-linecap="round"></path> </g></svg>
                        :
                        <svg width="36px" onClick={props.toggle} height="36px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" sstroke={windowHeight >= 500 ? props.open ? "white" : "#ffffff" : "#ffffff"}><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M16 8L8 16M8.00001 8L16 16" stroke={windowHeight >= 500 ? props.open ? "white" : "#ffffff" : "#ffffff"} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                    }
                </div>
            </nav>
            <div className="main-nav" style={props.open ? { display: "none"} : {   display: "block"}}>
                <h4 className="main-nav-header">
                    pexels Blog
                </h4>
                ...
                <ul className="main-nav-footer">
                    <li className="footer-icon"><svg class="spacing_noMargin__Q_PsJ" viewBox="0 0 9.215 16.95" width="9.215" fill='white' height="16.95"><use xlink:href="#facebook-logo-66e1477a575e084d94aa84c2997137f0"></use></svg></li>
