...
export default function Nav() {
    ...
    return (
        <nav  style={windowHeight >= 500 ? { backgroundColor: open ? "white" : "black", position: "fixed", top: "0", zIndex: "5" } : { backgroundColor: open ? "transparent" : "black" } }>
            ...
            <div className="nav-input-container" style={windowHeight >= 500 ? { visibility: 'visible' } : { visibility: 'hidden' }}>
                <div className="input-left">
                    <img src={img} alt="" />
                    <h3 className="left-paragraph" style={windowHeight >= 500 ? {display: "none"} : {display: "block"}} >
                        photos
                    </h3>
            ...
            <div className="hamburger">
                <button className={open ?  "nav-btn": "none"} style={windowHeight >= 500 ? { backgroundColor: '#05A081', color: 'white', display: "none" } : { backgroundColor: 'white' }} >
                    join
                </button>
                {open ?
                    <svg width="24px" onClick={toggle} height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke= {windowHeight >= 500 ? "#000000" :"#ffffff"}><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 18L20 18" stroke={windowHeight >= 500 ? "#000000" :"#ffffff"} stroke-width="2" stroke-linecap="round"></path> <path d="M4 12L20 12" stroke={windowHeight >= 500 ? "#000000" :"#ffffff"} stroke-width="2" stroke-linecap="round"></path> <path d="M4 6L20 6" stroke={windowHeight >= 500 ? "#000000" :"#ffffff"} stroke-width="2" stroke-linecap="round"></path> </g></svg>
                    :
                    <svg width="36px" onClick={toggle} height="36px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={windowHeight >= 500 ? "#000000" :"#ffffff"}><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M16 8L8 16M8.00001 8L16 16" stroke={windowHeight >= 500 ? "#000000" :"#ffffff"} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                }
